            ...
            <div id="menu-bar">
                <ul>
                    ...
                    <li><a>Literature Club</a>
                        <ul>
                            <li><a href="literaturehome.php">Literature Club Home</a></li>
                            <li><a href="loginliterature.php">Admin Login</a></li>
...
<div id="content">
      <?php
       $sql="SELECT * FROM files WHERE club_id=4 ORDER BY time DESC";
